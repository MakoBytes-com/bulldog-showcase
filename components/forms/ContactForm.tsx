...
/** /contact/ "Get in touch" form — mirrors the live site's 3-field contact form. */
export function ContactForm({ turnstileSiteKey }: Props) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <LightField label="Full Name" name="name" required autoComplete="name" />
      <LightField label="Phone Number" name="phone" type="tel" required autoComplete="tel" />
      <LightField label="Email Address" name="email" type="email" autoComplete="email" />
      <div>
      ...
      <ConsentBlockLight text={CONSULT_CONSENT} />
